import 'package:chap15database/auth/login_page.dart';
...
class _RegisterPageState extends State<RegisterPage> {
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: ShapeDecoration(
                              color: Color.fromARGB(255, 142, 4,
                                  170), // Add your desired color here
                              shape: RoundedRectangleBorder(
                                ...
                                side: BorderSide(
                                  color: Color.fromARGB(255, 142, 4,
                                      170), // Replace with your desired border color
                                  width:
  ...
  updateCollectionForUser(String uid) {
    ...
    userDocRef.set({
      ...
      print("Updated successfully for user with UID: $uid");
    }).catchError((error) {
      print("Error updating for user with UID: $uid - $error");
    });
  }
}
